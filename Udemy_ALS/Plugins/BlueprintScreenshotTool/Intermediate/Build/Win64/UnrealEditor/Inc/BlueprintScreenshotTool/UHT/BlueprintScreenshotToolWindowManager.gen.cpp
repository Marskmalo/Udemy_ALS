...
FClassRegistrationInfo Z_Registration_Info_UClass_UBlueprintScreenshotToolWindowManager;
UClass* UBlueprintScreenshotToolWindowManager::GetPrivateStaticClass()
{
	using TClass = UBlueprintScreenshotToolWindowManager;
	if (!Z_Registration_Info_UClass_UBlueprintScreenshotToolWindowManager.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("BlueprintScreenshotToolWindowManager"),
			Z_Registration_Info_UClass_UBlueprintScreenshotToolWindowManager.InnerSingleton,
			StaticRegisterNativesUBlueprintScreenshotToolWindowManager,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UBlueprintScreenshotToolWindowManager.InnerSingleton;
}
UClass* Z_Construct_UClass_UBlueprintScreenshotToolWindowManager_NoRegister()
{
	return UBlueprintScreenshotToolWindowManager::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_BlueprintScreenshotTool_Source_BlueprintScreenshotTool_Public_BlueprintScreenshotToolWindowManager_h__Script_BlueprintScreenshotTool_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UBlueprintScreenshotToolWindowManager, UBlueprintScreenshotToolWindowManager::StaticClass, TEXT("UBlueprintScreenshotToolWindowManager"), &Z_Registration_Info_UClass_UBlueprintScreenshotToolWindowManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBlueprintScreenshotToolWindowManager), 1924481600U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_BlueprintScreenshotTool_Source_BlueprintScreenshotTool_Public_BlueprintScreenshotToolWindowManager_h__Script_BlueprintScreenshotTool_944308303(TEXT("/Script/BlueprintScreenshotTool"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_BlueprintScreenshotTool_Source_BlueprintScreenshotTool_Public_BlueprintScreenshotToolWindowManager_h__Script_BlueprintScreenshotTool_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_BlueprintScreenshotTool_Source_BlueprintScreenshotTool_Public_BlueprintScreenshotToolWindowManager_h__Script_BlueprintScreenshotTool_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
