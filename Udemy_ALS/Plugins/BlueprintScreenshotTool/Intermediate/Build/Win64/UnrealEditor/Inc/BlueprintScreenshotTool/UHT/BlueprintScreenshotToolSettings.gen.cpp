...
FClassRegistrationInfo Z_Registration_Info_UClass_UBlueprintScreenshotToolSettings;
UClass* UBlueprintScreenshotToolSettings::GetPrivateStaticClass()
{
	using TClass = UBlueprintScreenshotToolSettings;
	if (!Z_Registration_Info_UClass_UBlueprintScreenshotToolSettings.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("BlueprintScreenshotToolSettings"),
			Z_Registration_Info_UClass_UBlueprintScreenshotToolSettings.InnerSingleton,
			StaticRegisterNativesUBlueprintScreenshotToolSettings,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UBlueprintScreenshotToolSettings.InnerSingleton;
}
UClass* Z_Construct_UClass_UBlueprintScreenshotToolSettings_NoRegister()
{
	return UBlueprintScreenshotToolSettings::GetPrivateStaticClass();
}
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UBlueprintScreenshotToolSettings_Statics::NewProp_TakeScreenshotHotkey = { "TakeScreenshotHotkey", nullptr, (EPropertyFlags)0x0010000000004015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UBlueprintScreenshotToolSettings, TakeScreenshotHotkey), Z_Construct_UScriptStruct_FInputChord, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_TakeScreenshotHotkey_MetaData), NewProp_TakeScreenshotHotkey_MetaData) }; // 1048045253
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UBlueprintScreenshotToolSettings_Statics::NewProp_OpenDirectoryHotkey = { "OpenDirectoryHotkey", nullptr, (EPropertyFlags)0x0010000000004015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UBlueprintScreenshotToolSettings, OpenDirectoryHotkey), Z_Construct_UScriptStruct_FInputChord, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OpenDirectoryHotkey_MetaData), NewProp_OpenDirectoryHotkey_MetaData) }; // 1048045253
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_BlueprintScreenshotTool_Source_BlueprintScreenshotTool_Public_BlueprintScreenshotToolSettings_h__Script_BlueprintScreenshotTool_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UBlueprintScreenshotToolSettings, UBlueprintScreenshotToolSettings::StaticClass, TEXT("UBlueprintScreenshotToolSettings"), &Z_Registration_Info_UClass_UBlueprintScreenshotToolSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBlueprintScreenshotToolSettings), 2473944698U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_BlueprintScreenshotTool_Source_BlueprintScreenshotTool_Public_BlueprintScreenshotToolSettings_h__Script_BlueprintScreenshotTool_1517635624(TEXT("/Script/BlueprintScreenshotTool"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_BlueprintScreenshotTool_Source_BlueprintScreenshotTool_Public_BlueprintScreenshotToolSettings_h__Script_BlueprintScreenshotTool_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_BlueprintScreenshotTool_Source_BlueprintScreenshotTool_Public_BlueprintScreenshotToolSettings_h__Script_BlueprintScreenshotTool_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
