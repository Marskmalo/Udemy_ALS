...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FBSTScreenshotData;
class UScriptStruct* FBSTScreenshotData::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FBSTScreenshotData.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FBSTScreenshotData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FBSTScreenshotData, (UObject*)Z_Construct_UPackage__Script_BlueprintScreenshotTool(), TEXT("BSTScreenshotData"));
	}
	return Z_Registration_Info_UScriptStruct_FBSTScreenshotData.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FBSTScreenshotData.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FBSTScreenshotData.InnerSingleton, Z_Construct_UScriptStruct_FBSTScreenshotData_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FBSTScreenshotData.InnerSingleton;
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_BlueprintScreenshotTool_Source_BlueprintScreenshotTool_Public_BlueprintScreenshotToolTypes_h__Script_BlueprintScreenshotTool_Statics
{
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FBSTScreenshotData::StaticStruct, Z_Construct_UScriptStruct_FBSTScreenshotData_Statics::NewStructOps, TEXT("BSTScreenshotData"), &Z_Registration_Info_UScriptStruct_FBSTScreenshotData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBSTScreenshotData), 4168634230U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_BlueprintScreenshotTool_Source_BlueprintScreenshotTool_Public_BlueprintScreenshotToolTypes_h__Script_BlueprintScreenshotTool_2307974835(TEXT("/Script/BlueprintScreenshotTool"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_BlueprintScreenshotTool_Source_BlueprintScreenshotTool_Public_BlueprintScreenshotToolTypes_h__Script_BlueprintScreenshotTool_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_BlueprintScreenshotTool_Source_BlueprintScreenshotTool_Public_BlueprintScreenshotToolTypes_h__Script_BlueprintScreenshotTool_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_BlueprintScreenshotTool_Source_BlueprintScreenshotTool_Public_BlueprintScreenshotToolTypes_h__Script_BlueprintScreenshotTool_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_BlueprintScreenshotTool_Source_BlueprintScreenshotTool_Public_BlueprintScreenshotToolTypes_h__Script_BlueprintScreenshotTool_Statics::EnumInfo));
// ********** End Registration *********************************************************************
